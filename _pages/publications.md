...
I used to manage the Scalable Oversight team at [Anthropic](https://www.anthropic.com/), where we worked on providing reliable training rewards for Claude without human supervision, and was the research lead for the [Anthropic Fellows Program](https://alignment.anthropic.com/2025/anthropic-fellows-program-2026/), a 4-6 month fellowship for alignment research. Before that, I worked on building model organisms of misalignment, understanding chain-of-thought monitoring and implementing control evaluations as part of Anthropic's Alignment team. I was a PhD student in the [Department of Statistics](https://www.stats.ox.ac.uk/) at the University of Oxford, where I was supervised by [Arnaud Doucet](https://www.stats.ox.ac.uk/~doucet/) and [George Deligiannidis](https://www.stats.ox.ac.uk/~deligian/) and worked on the theory of diffusion models. I've also spent time with the [UK Frontier AI Taskforce](https://www.gov.uk/government/publications/frontier-ai-taskforce-second-progress-report) (now the UK AI Safety Institute).
